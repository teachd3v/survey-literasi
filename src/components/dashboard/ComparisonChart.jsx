...
export default function ComparisonChart({ surveyType, dateFrom, dateTo, tbmVisit }) {
  ...
  useEffect(() => {
    ...
    fetchNeonComparison(surveyType, activeGroup, { dateFrom, dateTo, tbmVisit })
      .then(d => {
        if (!cancelled) {
  ...
  }, [surveyType, activeGroup, dateFrom, dateTo, tbmVisit]);
