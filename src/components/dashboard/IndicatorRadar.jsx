...
export default function IndicatorRadar({ lingkup, surveyType = 'literasi', onDataLoaded, dateFrom, dateTo, tbmVisit, kabupaten, desa, sekolah, tbm }) {
  ...
  useEffect(() => {
    ...
    fetchNeonIndicators(surveyType, lingkup, { dateFrom, dateTo, tbmVisit, kabupaten, desa, sekolah, tbm })
      .then(d => {
        if (!cancelled) {
