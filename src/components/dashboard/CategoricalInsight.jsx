...
export default function CategoricalInsight({ lingkup, surveyType = 'literasi', dateFrom, dateTo, tbmVisit, onDataLoaded }) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetchNeonCategoricalStats(surveyType, lingkup, { dateFrom, dateTo, tbmVisit }),
